...
INPUT_COLUMN = 2 # column for specific input in inputs 
TRUE_WEIGHT = -7  # true weigth value to be recovered | stored to prettier comparative analysis of the results
